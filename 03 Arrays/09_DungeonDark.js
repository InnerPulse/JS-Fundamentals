function solve(str) {
    ...
    class Player {
        ...
        fight = (monster, att) => {
            ...
            if (this.state.hp > 0) {
                ...
                console.log(`You died! Killed by ${monster}. Best room: ${this.state.room}`);
            }
        };
    }
    ...
    if (CurrentPlayer.state.isAlive) {
        console.log(`You've made it! Coins: ${CurrentPlayer.state.coins} Health: ${CurrentPlayer.state.hp}`);
    }
}
